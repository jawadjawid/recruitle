...
import { GET_EMPLOYER, GET_APPLICANT, UPDATE_APPLICANT, 
    UPDATE_EMPLOYER, GET_APPLICANTS, GET_APPLICATIONS, 
    GET_POSTINGS, GET_APPLICATIONS_COUNT } from '../../queries/queries';
